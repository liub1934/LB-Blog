...
<?php wp_enqueue_script( 'support', get_template_directory_uri() . '/js/support.min.js', false, wp_get_theme()->get('Version'), array('jquery') );
		wp_enqueue_script( 'app', get_template_directory_uri() . '/js/app.min.js', false, wp_get_theme()->get('Version'), array('jquery','func','support') );
