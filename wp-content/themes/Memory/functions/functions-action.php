...
function comment_add_owo($comment_text, $comment = '') {
    ...
    $data_OwO = array(
        ...
        //小电视
        '@[xds-白眼]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/baiyan.png" alt="白眼" class="OwO-img">',
        '@[xds-doge]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/doge.png" alt="doge" class="OwO-img">',
        '@[xds-坏笑]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/huaixiao.png" alt="坏笑" class="OwO-img">',
        '@[xds-难过]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/nanguo.png" alt="难过" class="OwO-img">',
        '@[xds-生气]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/shengqi.png" alt="生气" class="OwO-img">',
        '@[xds-委屈]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/weiqu.png" alt="委屈" class="OwO-img">',
        '@[xds-斜眼笑]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/xieyanxiao.png" alt="斜眼笑" class="OwO-img">',
        '@[xds-发呆]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/fadai.png" alt="发呆" class="OwO-img">',
        '@[xds-发怒]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/fanu.png" alt="发怒" class="OwO-img">',
        '@[xds-惊吓]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/jingxia.png" alt="惊吓" class="OwO-img">',
        '@[xds-呕吐]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/outu.png" alt="呕吐" class="OwO-img">',
        '@[xds-思考]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/sikao.png" alt="思考" class="OwO-img">',
        '@[xds-微笑]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/weixiao.png" alt="微笑" class="OwO-img">',
        '@[xds-疑问]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/yiwen.png" alt="疑问" class="OwO-img">',
        '@[xds-大哭]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/daku.png" alt="大哭" class="OwO-img">',
        '@[xds-鼓掌]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/guzhang.png" alt="鼓掌" class="OwO-img">',
        '@[xds-抠鼻]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/koubi.png" alt="抠鼻" class="OwO-img">',
        '@[xds-亲亲]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/qinqin.png" alt="亲亲" class="OwO-img">',
        '@[xds-调皮]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/tiaopi.png" alt="调皮" class="OwO-img">',
        '@[xds-笑哭]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/xiaoku.png" alt="笑哭" class="OwO-img">',
        '@[xds-晕]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/yun.png" alt="晕" class="OwO-img">',
        '@[xds-点赞]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/dianzan.png" alt="点赞" class="OwO-img">',
        '@[xds-害羞]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/haixiu.png" alt="害羞" class="OwO-img">',
        '@[xds-睡着]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/shuizhao.png" alt="睡着" class="OwO-img">',
        '@[xds-色]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/se.png" alt="色" class="OwO-img">',
        '@[xds-吐血]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/tuxue.png" alt="吐血" class="OwO-img">',
        '@[xds-无奈]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/wunai.png" alt="无奈" class="OwO-img">',
        '@[xds-再见]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/zaijian.png" alt="再见" class="OwO-img">',
        '@[xds-流汗]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/liuhan.png" alt="流汗" class="OwO-img">',
        '@[xds-偷笑]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/touxiao.png" alt="偷笑" class="OwO-img">',
        '@[xds-抓狂]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/zhuakuang.png" alt="抓狂" class="OwO-img">',
        '@[xds-黑人问号]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/heirenwenhao.png" alt="黑人问号" class="OwO-img">',
        '@[xds-困]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/kun2.png" alt="困" class="OwO-img">',
        '@[xds-打脸]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/dalian.png" alt="打脸" class="OwO-img">',
        '@[xds-闭嘴]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/bizui.png" alt="闭嘴" class="OwO-img">',
        '@[xds-鄙视]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/bishi.png" alt="鄙视" class="OwO-img">',
        '@[xds-腼腆]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/miantian.png" alt="腼腆" class="OwO-img">',
        '@[xds-馋]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/chan.png" alt="馋" class="OwO-img">',
        '@[xds-可爱]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/keai.png" alt="可爱" class="OwO-img">',
        '@[xds-发财]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/facai.png" alt="发财" class="OwO-img">',
        '@[xds-生病]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/shengbing.png" alt="生病" class="OwO-img">',
        '@[xds-流鼻血]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/liubixue.png" alt="流鼻血" class="OwO-img">',
        '@[xds-尴尬]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/ganga.png" alt="尴尬" class="OwO-img">',
        '@[xds-大佬]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/dalao.png" alt="大佬" class="OwO-img">',
        '@[xds-流泪]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/liulei.png" alt="流泪" class="OwO-img">',
        '@[xds-冷漠]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/lengmo.png" alt="冷漠" class="OwO-img">',
        '@[xds-皱眉]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/zhoumei.png" alt="皱眉" class="OwO-img">',
        '@[xds-鬼脸]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/guilian.png" alt="鬼脸" class="OwO-img">',
        '@[xds-调侃]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/tiaokan.png" alt="调侃" class="OwO-img">',
        '@[xds-目瞪口呆]' => '<img src="'.$emojiCDN.'/emoji/xiaodianshi/mudengkoudai.png" alt="目瞪口呆" class="OwO-img">',
        //滑小稽
