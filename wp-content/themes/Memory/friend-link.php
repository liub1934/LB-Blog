												...
												if ( !empty($bookmarks) ) {
													foreach ($bookmarks as $bookmark) {
														...
														if($bookmark->link_notes!=null && $bookmark->link_notes!='') 
															echo '<img data-original="'.get_avatar_url($bookmark->link_notes).'" src="'.get_template_directory_uri().'/img/squares.svg" alt="'.$bookmark->link_name.'" class="avatar lazy" / >';
														else
														...
														echo '<div class="link-text"><span class="link-title">'.$bookmark->link_name.'</span><p title="'.$bookmark->link_description.'" class="link-description">'.$bookmark->link_description.'</p></div>';
														echo '</a></li>';
													}
												} ?>
												</ul>
